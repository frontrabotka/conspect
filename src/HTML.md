...
<span class="cursive"><small>Дата последней правки: </small><time datetime="2025-04-28"><small>28 апреля 2025</small></time></span>
...
Пути к HTML-файлам чувствительны к регистру. Имя файла и расширение в атрибуте `src` должны точно совпадать с фактическим именем файла. При использовании нескольких слов в названии файла, используйте `-` или `_` в качестве разделителя, а не пробел.
