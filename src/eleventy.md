...
Фильтр `| reverse` инвертирует текущий порядок сортировки элементов коллекции. Он не меняет критерий сортировки (например, по дате, по заголовку и т.д.).

Способ сортировки контента в коллекции можно поменять, если изменить значение ключа `date` во Front Matter:
